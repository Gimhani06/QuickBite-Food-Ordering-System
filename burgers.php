...
<div class="page-title">
	<h2>Burgers</h2>
	<p>Choose a burger and add it to your cart</p>
</div>
...
<div class="menu-grid">
	...
	<div class="card">
		<div class="card-image-wrap">
			<img src="images\chicken burger.jpg.jpeg" alt="Chicken Burger">
			<span class="price-badge">Rs.200.00</span>
		</div>
		<div class="card-content">
			<h3>Chicken Burger</h3>
			<p>Delicious burger with grilled chicken and fresh vegetables.</p>
	...
	<div class="card">
		<div class="card-image-wrap">
			<img src="images\fishburger.jpg" alt="Fish Burger">
			<span class="price-badge">Rs.160.00</span>
		</div>
		<div class="card-content">
			<h3>Fish Burger</h3>
			<p>Delicious burger with grilled fish and fresh vegetables.</p>
			<button class="add-to-cart-btn">+ Add to Cart</button>
		</div>
	</div>
