...
<div class="menu-grid">
	...
	<div class="card">
		...
		<div class="card-content">
			...
			<p>Delicious grilled salmon with herbs and lemon.</p>
	...
	<div class="card">
		<div class="card-image-wrap">
			...
			<span class="price-badge">Rs.300.00</span>
		</div>
		<div class="card-content">
			<h3>Artisan Sandwich</h3>
			<p>Delicious sandwich with fresh ingredients and special sauce.</p>
			<button class="add-to-cart-btn">+ Add to Cart</button>
		</div>
	</div>
    ...
    <div class="card">
		<div class="card-image-wrap">
			...
			<span class="price-badge">Rs.300</span>
		</div>
		<div class="card-content">
			<h3>Artisan Sandwich</h3>
			<p>Delicious sandwich with fresh ingredients and special sauce.</p>
