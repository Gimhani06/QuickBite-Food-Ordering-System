...
<div class="page-title">
	<h2>Main Courses</h2>
	<p>Choose a main course and add it to your cart</p>
</div>
...
<div class="menu-grid">
	...
	<div class="card">
		<div class="card-image-wrap">
			<img src="images/fried rice.jpg.jpeg" alt="Fried Rice">
			<span class="price-badge">Rs.200.00</span>
		</div>
		<div class="card-content">
			<h3>Fried Rice</h3>
			<p>Delicious chicken fried rice with fresh vegetables.</p>
	...
	<div class="card">
		<div class="card-image-wrap">
			<img src="images/chicken koththu.jpg.jpeg" alt="Chicken Koththu">
			<span class="price-badge">Rs.160.00</span>
		</div>
		<div class="card-content">
			<h3>Koththu</h3>
			<p>Traditional Sri Lankan koththu with bold spices.</p>
			<button class="add-to-cart-btn">+ Add to Cart</button>
		</div>
	</div>
