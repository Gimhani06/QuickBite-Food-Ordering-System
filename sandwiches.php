...
<div class="page-title">
	<h2>Sandwiches</h2>
	<p>Choose a sandwich and add it to your cart</p>
</div>
...
<div class="menu-grid">
	...
	<div class="card">
		<div class="card-image-wrap">
			<img src="images\chicken sandwich 2.jpg.jpeg" alt="Chicken Sandwich">
			<span class="price-badge">Rs.200.00</span>
		</div>
		<div class="card-content">
			<h3>Chicken Sandwich</h3>
			<p>Delicious chicken sandwich with fresh vegetables and mayo.</p>
	...
	<div class="card">
		<div class="card-image-wrap">
			<img src="images\egg sandwich.jpg.jpeg" alt="Egg Sandwich">
			<span class="price-badge">Rs.160.00</span>
		</div>
		<div class="card-content">
			<h3>Egg Sandwich</h3>
			<p>Delicious egg sandwich with fresh vegetables and mayo.</p>
			<button class="add-to-cart-btn">+ Add to Cart</button>
		</div>
	</div>
